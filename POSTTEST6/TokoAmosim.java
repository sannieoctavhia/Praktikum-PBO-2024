...
public class TokoAmosim implements ErrorHandling {
        ...
        do {
            ...
            switch (pilihan) {
                ...
                case 5:
                    ...
                    break;
                default:
                    handleErrorMessage("Pilihan tidak valid. Silahkan pilih menu 1-5");
            }
        } while (pilihan != 5);
    }
    ...
    private static void lihatProduk(ArrayList<Merchandise> daftarProduk) {
        if (daftarProduk.isEmpty()) {
            handleErrorMessage("Tidak ada produk yang tersedia.");
        } else {
    ...
    private static void updateProduk(ArrayList<Merchandise> daftarProduk, Scanner scanner) {
        ...
        if (!daftarProduk.isEmpty()) {
            ...
            if (nomorProduk >= 1 && nomorProduk <= daftarProduk.size()) {
                ...
                handleErrorMessage("Nomor produk tidak valid.");
            }
        }
    }
